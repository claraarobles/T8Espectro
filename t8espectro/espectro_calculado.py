...
def calcular_fft(wave, srate, n_fft=None):
    ...
    n_fft (int, opcional): El número de puntos para calcular la FFT. Si no se especifica, se usa el tamaño de la señal.
    Retorna:
        - half_freqs (array-like): Las frecuencias correspondientes a los componentes de la FFT.
